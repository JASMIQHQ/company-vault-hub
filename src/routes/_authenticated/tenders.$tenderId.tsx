...
function TenderWorkspacePage() {
  ...
  const isProcessing = status === "processing" || analysisSubmitting || analyze.isPending;
  let readActionLabel = "Read Tender";
  if (isProcessing) {
    readActionLabel = "Reading tender...";
  } else if (hasSavedRequirements) {
