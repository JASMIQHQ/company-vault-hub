...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Jasmiq Procurement AI" },
      { name: "description", content: "Secure company document vault for procurement compliance." },
      { property: "og:title", content: "Jasmiq Procurement AI" },
      { property: "og:description", content: "Secure company document vault for procurement compliance." },
    ...
    links: [
      ...
      { rel: "icon", href: "/jasmiq-favicon.svg", type: "image/svg+xml" },
    ],
  }),
