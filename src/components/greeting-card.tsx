...
export function GreetingCard({ firstName, companyName, organizationsCount = 1, onCompanyChange }: GreetingCardProps) {
  return (
    <section className="jasmiq-hero-v2 relative mb-7 overflow-hidden rounded-[2rem] border border-white/10 shadow-[0_35px_110px_-48px_rgba(15,23,42,0.72)]">
      ...
      <div className="relative z-10 grid gap-8 p-5 sm:p-8 lg:grid-cols-[1.08fr_.92fr] lg:p-10">
        <div className="flex min-w-0 flex-col justify-center">
          <div className="jasmiq-reveal inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-white/[0.07] px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-primary shadow-sm backdrop-blur-2xl dark:bg-white/[0.08]">
          ...
          <p className="jasmiq-reveal mt-5 text-sm font-medium text-slate-300 [animation-delay:90ms]">
          ...
          <p className="jasmiq-reveal mt-5 max-w-2xl text-sm leading-6 text-slate-300 sm:text-base sm:leading-7 [animation-delay:200ms]">
          ...
          <div className="jasmiq-reveal mt-7 flex flex-wrap items-center gap-3 [animation-delay:260ms]">
            <button
              ...
              className="group inline-flex min-w-0 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.08] px-3.5 py-2.5 text-left shadow-[0_14px_35px_-22px_rgba(37,99,235,.45)] backdrop-blur-2xl transition-all duration-500 hover:-translate-y-0.5 hover:border-primary/25 hover:bg-white/80 dark:bg-white/[0.08] dark:hover:bg-white/[0.12]"
            >
              <span className="grid size-8 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary">
                <Building2 className="size-4" />
              </span>
              <span className="min-w-0">
                <span className="block text-[9px] font-bold uppercase tracking-[0.16em] text-slate-300">Active workspace</span>
                <span className="block max-w-[220px] truncate text-sm font-semibold text-white">{companyName ?? "Select a company"}</span>
              </span>
              {organizationsCount > 1 ? <ArrowUpRight className="ml-1 size-4 shrink-0 text-slate-300 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" /> : null}
            </button>
        ...
        <div className="relative min-h-[270px] overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/[0.055] p-4 shadow-inner backdrop-blur-2xl dark:bg-white/[0.035] sm:min-h-[320px]">
          ...
          <div className="absolute inset-x-8 top-8 flex justify-between text-[9px] font-bold uppercase tracking-[0.18em] text-slate-300/70">
          ...
          <div className="jasmiq-intelligence-core absolute left-1/2 top-[52%] grid size-28 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-[2rem] border border-white/10 bg-white/[0.09] shadow-[0_25px_70px_-25px_rgba(37,99,235,.6)] backdrop-blur-2xl dark:bg-white/[0.08]">
          ...
          <div className="jasmiq-float-card absolute left-5 top-[44%] rounded-2xl border border-white/10 bg-white/[0.09] px-3 py-2 shadow-[0_18px_45px_-24px_rgba(15,23,42,.35)] backdrop-blur-2xl dark:bg-white/[0.08]">
            <p className="text-[9px] font-bold uppercase tracking-[0.14em] text-slate-300">Vault</p>
          ...
          <div className="absolute bottom-4 left-4 right-4 grid grid-cols-3 gap-2">
            {["Tender", "Evidence", "Action"].map((item, index) => (
              <div key={item} className="rounded-xl border border-white/10 bg-white/[0.07] px-2 py-2 text-center backdrop-blur-xl dark:bg-white/[0.05]">
