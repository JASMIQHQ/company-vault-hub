...
export function UploadDialog({ organizationId }: { organizationId: string }) {
  ...
  const suggestion = useMemo(
    () => (file ? suggestFromFilename(file.name) : null),
    [file],
  );
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      void supabase.functions
        .invoke("verify-document", { body: { document_id: documentId } })
        .then(({ error }) => {
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1 space-y-2">
                  ...
                  <p className="text-sm text-foreground">
                    {suggestion.type
                      ? DOCUMENT_TYPE_LABELS[suggestion.type]
                      : suggestion.name}
                  </p>
          ...
          {suggestionAccepted && (
            <div className="flex items-center gap-2 rounded-xl border border-success/20 bg-success/5 px-3 py-2 text-xs text-muted-foreground">
              ...
              Suggestion accepted. You can still edit it.
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            >
              ...
              {FEDERAL_TENDER_DOCUMENT_TYPES.map((type) => (
