...
export function deriveRequirementGuidance(
  ...
  if (status === "matched") {
    return {
      ...
      explanation:
        cleanExplanation ||
        "An official document matching all criteria was successfully verified.",
      action: null,
    };
  }
  ...
  switch (failureReason) {
    ...
    case "NO_CANDIDATE_DOCUMENT":
      return {
        ...
        explanation:
          "No document in the Company Vault appears to relate to this requirement.",
    ...
    case "CONFIDENCE_TOO_LOW":
      return {
        ...
        explanation:
          "A candidate document was found but did not meet the required threshold.",
        action: "Review this document manually",
      };
    case "CONFLICTING_EVIDENCE":
      return {
        ...
        explanation:
          "Multiple documents produced contradictory evidence for this requirement.",
